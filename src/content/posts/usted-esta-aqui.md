...
Diferencias estructurales fundamentales en acceso a energía, internet y educación:

![](</images/Norte Sur Diferencias- Q1 2026 Trends and Insights - Microsoft-AI-Diffusion-Report-2026-Q1.pdf.png>)
...
**Por otro lado, ¿agrega o no valor la IA? Depende: el 23% de las organizaciones latinoamericanas que utilizan IA dicen estar generando “algún valor" económico a partir de su implementación, ero solo 6% afirma crear un "valor significativo”.**&#x20;

Según este estudio, "la limitada aplicación de la IA analítica y la IA generativa a gran escala en las operaciones" podría explicar el bajo nivel actual de captación de valor de estas tecnologías. De hecho, **el mayor impacto de las soluciones de IA lo perciben en especial las grandes empresas**, mientras **59% de las pequeñas y medianas afirma no estar generando ningún valor medible a partir de su empleo**.&#x20;

A la vez las empresas que dicen no extraer valor también dicen que implementar la tecnología les lleva más de 12 meses, mientras que las que sí lo generan, demoran entre 6 y 9 meses en la ejecución de proyectos.&#x20;

> Lo que sigue llamando la atención es que **apenas 10% de los encuestados reconoce que su estrategia de IA está vinculada a la estrategia general** del negoci&#x6F;**,** y en consecuencia tampoco saben cómo comunicarla dentro de la organización o cómo desarrollar/retener talento especializado.
